...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TrackApp.Droid.LocationServiceConnection, TrackApp.Android", LocationServiceConnection.class, __md_methods);
	}
	...
	public LocationServiceConnection ()
	{
		...
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("TrackApp.Droid.LocationServiceConnection, TrackApp.Android", "", this, new java.lang.Object[] {  });
	}
